  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className="min-h-screen">
        ...
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Cinzel:wght@400;600;700;800&family=Cormorant+Garamond:ital,wght@0,400;0,600;0,700;1,400;1,600&display=swap" rel="stylesheet" />
        <Providers>
          {children}
        </Providers>
        <Toaster />
